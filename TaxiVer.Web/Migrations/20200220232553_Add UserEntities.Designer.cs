...
namespace TaxiVer.Web.Migrations
{
    ...
    [Migration("20200220232553_Add UserEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaxiVer.Web.Data.Entities.TaxiEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TaxiVer.Web.Data.Entities.UserEntity", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TaxiVer.Web.Data.Entities.UserGroupEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TaxiVer.Web.Data.Entities.UserEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("Taxi.Web.Data.Entities.TripEntity", b =>
                {
                    b.HasOne("TaxiVer.Web.Data.Entities.TaxiEntity", "Taxi")
                        .WithMany("Trips")
                        .HasForeignKey("TaxiId");

                    b.HasOne("TaxiVer.Web.Data.Entities.UserEntity", "User")
                        .WithMany("Trips")
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("TaxiVer.Web.Data.Entities.UserEntity", b =>
                {
                    b.HasOne("TaxiVer.Web.Data.Entities.UserGroupEntity")
                        .WithMany("Users")
